...
<Frame caption="Custody integrations page">
  <img src="/images/tga/custody/integrations-overview.png" />
</Frame>
...
<CardGroup cols={3}>
  <Card title="Fireblocks" icon="fire">
    Enterprise-grade digital asset infrastructure with MPC key management and policy engine.
  </Card>
  <Card title="Anchorage" icon="shield-halved">
    Institutional digital asset platform with qualified custody and staking.
  </Card>
  <Card title="Safe (Gnosis)" icon="vault">
    Multisig smart contract wallets with customizable signer thresholds.
  </Card>
</CardGroup>
...
- **Galaxy** — Trading and custody services
...
<Steps>
  <Step title="Navigate to Integrations">
    Go to **Admin** → **Integrations** from the sidebar.
  </Step>
  ...
  <Step title="Enter credentials">
    ...
    - **Safe**: Safe wallet address
  </Step>
  <Step title="Test connection">
    The system verifies connectivity before saving.
  </Step>
