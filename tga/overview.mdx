...
| **Other** | Custom grant type name defined by the organization |
...
<div className="toku-overview-cta">
  <div>
    <h3>Bring token grants into one platform</h3>
    <p>
      Manage grants, vesting, wallets, settlements, and distributions with Toku.
    </p>
  </div>
  <a className="toku-button toku-button-secondary" href="https://www.toku.com/stablecoin-payroll">
    Sign up for Toku
  </a>
</div>
